...
const breadcrumbConfig = {
    ...
    pathMap: {
        ...
        '/pages/business/hydrogen.html': {
            zh: '电解制氢技术与产品',
            en: 'Electrolytic Hydrogen Technology & Products'
        },
        '/pages/business/co2.html': {
            zh: '电解二氧化碳技术与产品',
            en: 'CO2 Electroreduction Technology & Products'
        },
...
class BreadcrumbNavigation {
    ...
    detectCurrentLanguage() {
        ...
        if (langToggle) {
            this.currentLanguage = langToggle.textContent === 'EN' ? 'zh' : 'en';
        }
    }
